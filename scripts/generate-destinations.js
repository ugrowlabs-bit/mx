...
<html lang="en"><head><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1" /><meta http-equiv="refresh" content="0; url=../${languagePath ? `${languagePath}/` : ""}" /><link rel="canonical" href="../${languagePath ? `${languagePath}/` : ""}" /><title>Money Exchange</title></head><body><script>location.replace("../${languagePath ? `${languagePath}/` : ""}")</script></body></html>
`;
